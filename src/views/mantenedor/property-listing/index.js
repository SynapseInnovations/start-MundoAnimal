...
// ** Step Components
import StepPropertyArea from 'src/views/mantenedor/property-listing/StepPropertyArea'
import StepPriceDetails from 'src/views/mantenedor/property-listing//StepPriceDetails'
import StepPropertyDetails from 'src/views/mantenedor/property-listing//StepPropertyDetails'
import StepPersonalDetails from 'src/views/mantenedor/property-listing//StepPersonalDetails'
import StepPropertyFeatures from 'src/views/mantenedor/property-listing//StepPropertyFeatures'
  ...
  const renderFooter = () => {
    ...
    return (
      <Box sx={{ p: 5, pb: 3, display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'flex-end' }}>
        ...
        >
          {stepCondition ? 'Submit' : 'Continuar'}
        </Button>
      </Box>
    )
  }
